...
#  if hid in hplZips:
#    hplZips[hid].add(hplzp)
#  else:
#    hplZips[hid] = set([hplzp])
#  if pid in patZips:
#    patZips[pid].add(zp)
#  else:
#    patZips[pid] = set([zp])
#  if pid in patHplZips:
#    patHplZips[pid].add(hplzp)
#  else:
#    patHplZips[pid] = set([hplzp])
#
...
#patgoodzip = dict()
#for item in patZips.items():
#    patgoodzip[item[0]] = set([zp for zp in item[1] if zp in pyZipCode.zipDict])
#
...
#patgoodhplzip = dict()
#for item in patHplZips.items():
#    patgoodhplzip[item[0]] = set([zp for zp in item[1] if zp in pyZipCode.zipDict])
#
...
#hplgoodzip = dict()
#for item in hplZips.items():
#    hplgoodzip[item[0]] = set([zp for zp in item[1] if zp in pyZipCode.zipDict])
#
